    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-64 bg-black text-white relative">
        ...
        <nav className="mt-4 px-4">
          ...
          <SidebarLink icon={FaRocket} text="Deployments" active />
...
const SidebarLink = ({ icon: Icon, text, active }) => (
  <Link to="#" className={`flex items-center space-x-2 p-4 rounded ${active ? 'bg-yellow-500 text-black' : 'hover:bg-gray-800'}`}>
